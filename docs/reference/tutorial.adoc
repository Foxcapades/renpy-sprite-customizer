...
:sectanchors: 1
:revnumber: any
:imagesdir: https://foxcapades.github.io/renpy-sprite-customizer/assets/images/tutorial/
...
define player_customizer = CustomizedSprite(
    ...
    SCLayer( <2>
        "skin", <3>
        skin_lcb, <4>
        skin_base=("Skin Base", "Body", [ "dark", "medium", "light" ]), <6>
...
<6> Skin base option, directly relates to the skin base image files included in
...
option tuple.
<6> The option value tuple, the first value is what will be used when the
